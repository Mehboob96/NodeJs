...
/*	callback function
Asynchronous FileReading
readFile("filename.extention","encoding",function(error,data))

Synchronous FileReading
readFileSync("filename.extention","encoding",function(error,data))